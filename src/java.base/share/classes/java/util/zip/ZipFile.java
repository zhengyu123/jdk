...
public class ZipFile implements ZipConstants, Closeable {
    ...
    // Cached CEN in heap
    private static class InHeapCEN implements CEN {
        private byte[] cen;
    ...
    private static class Source {
        private static boolean USE_MAPPED_CEN;
        static {
            try {
                USE_MAPPED_CEN = Boolean.parseBoolean(System.getProperty("java.util.zip.ZipFile.useMappedCEN", "false"));
            ...
            throws ZipException
        {
            ...
            try {
                ...
                if (clen > 0) {
                    ...
                    byte[] data = cen.segment(start, clen);
                    zcp.toString(data, 0, clen);
                }
            } catch (Exception e) {
        ...
        private void initCEN(int knownTotal) throws IOException {
            ...
            if (knownTotal == -1) {
                ...
                if (cen == null) {
                    ...
                    cen = this.cen = new InHeapCEN(content);
                }
        ...
        private int getEntryPos(String name, boolean addSlash) {
            ...
            while (idx != ZIP_ENDCHAIN) {
                if (getEntryHash(idx) == hsh) {
                    ...
                    byte[] data = cen.segment(noff, nlen);
                    switch (zc.compare(name, data, 0, nlen, addSlash)) {
                        case EXACT_MATCH:
