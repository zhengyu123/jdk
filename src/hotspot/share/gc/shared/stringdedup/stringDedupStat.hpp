...
//
// Operation counters are updated when deduplicating a string.  Most of
// these must be accessed while holding StringDedup_lock, because both the
// processing thread and mutators may be attempting deduplication operations
// concurrently.
//
